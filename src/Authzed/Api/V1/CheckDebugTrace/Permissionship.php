...
/**
 * Protobuf type <code>authzed.api.v1.CheckDebugTrace.Permissionship</code>
 */
...
class_alias(Permissionship::class, \Authzed\Api\V1\CheckDebugTrace_Permissionship::class);
